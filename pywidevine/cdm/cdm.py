...
class Cdm:
    ...
    def set_service_certificate(self, session_id, cert_b64):
        self.logger.debug(
            "set_service_certificate(session_id={}, cert={})".format(session_id, cert_b64))
    ...
    def get_license_request(self, session_id):
        ...
        self.logger.debug("license request b64: {}".format(
    ...
    def provide_license(self, session_id, license_b64):
        self.logger.debug("provide_license(session_id={}, license_b64={})".format(
        ...
        self.logger.debug("calculated sig: {} actual sig: {}".format(
        ...
        for key in license.Msg.Key:
            ...
            self.logger.debug("Type: {}; Key: {}".format(type, key))
